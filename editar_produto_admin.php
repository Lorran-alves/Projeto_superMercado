...
<?php if($_GET['area'] == "editar"){?>
    ...
    <section class="row">
            <input type="submit" value="Salvar" class="botao-salvar" name= 'button' onclick="verificaMetodo('Salvar', <?=$_GET['id_produto']?>)">
            <input type="submit" value="Remover" class="botao-remover" name= 'button' onclick="verificaMetodo('Remover', <?=$_GET['id_produto']?>)">
             <input type="submit" value="Cancelar" class="botao-cancelar" name= 'button'  onclick="verificaMetodo('Cancelar', <?=$_GET['id_produto']?>)">
        </section>
        </section>
