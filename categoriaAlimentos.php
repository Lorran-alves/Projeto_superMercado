...
<i class="fa-solid fa-caret-left left"  onclick="requisitarPagina('containerAlimentos', 'categoriaAlimentos.php?acao=recuperarProdutosPorCategoria&categoria=Alimentos&lado=left')"></i>
<i class="fa-solid fa-caret-right right" onclick="requisitarPagina('containerAlimentos', 'categoriaAlimentos.php?acao=recuperarProdutosPorCategoria&categoria=Alimentos&lado=right')"></i>
